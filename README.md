...
![Titelbildschirm mit GELBE EDITION](screenshots/titel-gelbe-edition.png)

![Deutscher Trainerwechsel-Text](screenshots/trainerwechsel.png)

![Statusbildschirm mit GIF und deutschen Wertekürzeln](screenshots/status-gif.png)

## Installation

1. Unter **Releases** die Datei `deutsch-gelb-1.0.0.zip` herunterladen.
